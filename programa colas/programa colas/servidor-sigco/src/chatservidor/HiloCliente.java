 ...
 * al servidor y dicho hilo tiene como función escuchar solamente a ese cliente.
 *
...
//                for (HiloCliente h : server.clientes) {
//                    if (destinatario.equals(h.getIdentificador())) {
...
//                }
            ...
            case "LLAMAR_PACIENTE":
                ...
                server.clientes
                        .stream()
                        .filter(h -> (lista.get(2).equals(h.getIdentificador())))
                        .forEach((h) -> h.enviarMensaje(lista));
                break;
            case "NO_HAY_TURNOS":
                server.clientes
